...
def scan_sub_stats(context: Context, image: np.ndarray, base_x: int, base_y: int):
    stat_rois = [
        # Row 1
        {"type": "name", "roi": [0, 0, 200, 33]},
        {"type": "val",  "roi": [200, 0, 54, 33]},
        {"type": "name", "roi": [265, 0, 185, 33]},
        {"type": "val",  "roi": [450, 0, 80, 33]},
        # Row 2
        {"type": "name", "roi": [0, 38, 200, 33]},
        {"type": "val",  "roi": [200, 38, 54, 33]},
        {"type": "name", "roi": [265, 38, 185, 33]},
        {"type": "val",  "roi": [450, 38, 80, 33]},
    ]
